...
## Purpose
The faucet page provides a user interface for claiming YD Tokens from the YDFaucet smart contract. Users can claim a fixed amount of test tokens once per wallet address, enabling them to participate in the platform's marketplace and purchase courses.
## Requirements
