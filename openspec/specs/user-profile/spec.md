...
## Purpose
Provides a dedicated user profile page (`/me`) where users can view their wallet information (address, chain ID, ETH balance) and manage their profile settings, specifically their nickname. The page handles both connected and disconnected wallet states, allowing users to connect their wallet if needed and edit their nickname with proper validation.
## Requirements
